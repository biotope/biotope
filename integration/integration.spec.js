...
describe('biotope', () => {
  ...
  //     expect(process.cwd() + '/test-components/my-component').to.be.a.directory().with.contents([
  //       'index.ts',
  //       'my-component.ts',
  //       'styles.scss',
  //       'template.ts',
  ...
  //       'scaffolding'
  //     ]);
  //     expect(process.cwd() + '/test-components/my-component/scaffolding').to.be.a.directory().with.contents([
  //       'my-component.hbs',
  //     ]);
  //     expect(process.cwd() + '/test-pages').to.be.a.directory().with.contents([
  //       '10components.my-component.hbs'
  //     ]);
